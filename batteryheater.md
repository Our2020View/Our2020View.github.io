...
The plan is to bypass the auto shutoff function in the controller someday, but I did add a receptacle on the entry side wall of the kitchen base cabinet so I could easily plug in the pad.   (The receptacle has a split circuit – one plug will is a dedicated 20 amp circuit for an electric heater, and the other plug is be tied to the house 15 amp receptacles using the existing inverter capable supply.)  I had considered continuing my search to find a pad that did not have the auto off function, but now that I have it installed and working so well, I think I will spend the time to figure out how to eliminate the auto off nuisance.  
