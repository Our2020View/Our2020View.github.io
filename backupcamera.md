...
The remaining part of the camera replacement project was drama fee; I used Dicor 501LSW (white) to seal the edges of the top of the end cap.  (I discovered that there is quite a bit of controversy and misunderstanding on-line regarding the use Dicor on a fibreglass roof - Dicor has been formulated for fibreglass, but it has not been formulated to be applied overtop of silicone based sealant.)   I finished up by caulking the cap ends with one of the recommended roof radius products - and called it a wrap.
