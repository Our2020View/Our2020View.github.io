...
This drawing shows how the switch was wired up (only the relevant solar inputs are shown) - the red wires are the only addition to the Winnebago setup:
