...
2 - What is that yellow Winnebago power wire that is also connected to the terminal of the Zamp solar input wire?  Good question.  That appears to be the power wire coming from the auxillary solar port in the electrical bay, behind the shore power cord.  Quite by accident, I found a 15 amp circuit breaker in the back of the wet bay, and traced the wire identifier to an input to the Zamp solar controller.  That all makes good sense to me, as the basic Zamp installation only includes the big # 8 wires that the diagram above illustrates.  The 15 amp circuit breaker in line on that yellow # 10 / 30 amp power wire in the wet bay would be able to accomodate a pretty large portable panel; a 200 watt portable panel would only be able to give you 10 - 12 amps of current.  (Don't forget that the Zamp controller that came with the motorhome is only rated for a maximum of 510 watts, or about 29 amps / 17.5 volts coming from all of the panels you have hooked up.  So with a 200 watt factory solar install - in theory that leaves you 310 watts of panel capability down at the auxillary solar port in the electrical bay.  But 310 watts at the 17.5 volts that you'd want to match for the factory panels would produce over 15 amps of current... blowing that fuse in the wet bay.  Something like a 200 watt portable panel would make sense to me as the biggest I would want to go.)
