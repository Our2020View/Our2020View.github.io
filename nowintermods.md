...
TIP - Discharging or charging the coach batteries do warm them up nicely.  If your lithium batteries are too cold to accept a charge - and you have the luxury of using a bit of battery capacity to power a large load - try running the microwave for a couple of minutes.  That might get you above the charge cutout temperature controlled by your lithium battery management system and allow the batteries to get happy accepting a charge.  (If you don't have temperature monitoring of you lithium coach batteries, and you do plan on spending time camping in the cold, I highly recommend you adding that feature to your mod list...)
