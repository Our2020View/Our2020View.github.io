...
On the topic of annoying noises, whenever going over a bump we'd get a "clank" followed by a "thump".  Also, when jumping off the ladder when coming down from the roof, I'd get the same results.  It turns out the spare tire cradle and tire are not secured very well - The cradle is held securly to the threaded rod, but because the threaded rod has not been positioned correctly on its support post, the cradle is not compressing the tire against the roof stub as I assume it was intended.  the result is the cradle rattles around and the tire is free to jump around when going over a bump.  On our View there is only about 1/4" of thread on the rod to play with, but it was enough to be able to lower the cradle a bit and jam in a piece of 2" closed cell foam to take up the space between the tire sidewll and the ceiling stub.  When the cradel was raised a bit with the threads left over on the rod, it was enough to firmly hold the cradle and tire in place.  The first photo shows the threaded rod as I found it - the threaded rod is suspended too low on the support post.  The second photo shows the 2" closed cell foam I inserted to take up the space and compress the tire in place.
