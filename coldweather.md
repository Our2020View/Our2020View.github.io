...
But, not so fast ... unfortunately I found this really valuable video by the Newstate Nomads - it does a great job of revealing what the weak spot in a View / Navion is when trying to use the coach in seriously cold temperatures.  The good news is that the solution to the problem is not a big deal.  So, first, have a look at the problem:
