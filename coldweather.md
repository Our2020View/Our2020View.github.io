...
Yes, it works as we hoped it would.  Some of these were pretty easy mods to make, but they change the game considerably on being able to use the motorhome when the temperature drops.  We can keep our plumbing warm while driving across areas of sub-zero tempertures, or even use the coach to camp with both types of power options.  
